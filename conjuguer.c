...
int main(int numberOfArguments, char** arguments) {
    ...
    if (verbe[length - 2] == 'i') {
        PrintString("Je "); PrintString(Strcat(radicale, "is")); NextLine(); Strcpy(radicale, root);
        PrintString("Tu "); PrintString(Strcat(radicale, "is")); NextLine(); Strcpy(radicale, root);
        PrintString("Il "); PrintString(Strcat(radicale, "it")); NextLine(); Strcpy(radicale, root);
        PrintString("Nous "); PrintString(Strcat(radicale, "issons")); NextLine(); Strcpy(radicale, root);
        PrintString("Vous "); PrintString(Strcat(radicale, "issez")); NextLine(); Strcpy(radicale, root);
        PrintString("Ils ou Elles "); PrintString(Strcat(radicale, "issent")); NextLine(); Strcpy(radicale, root);
    } else {
